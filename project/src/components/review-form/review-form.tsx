  ...
  return (
    <form className='reviews__form form' action='#' method='post' onSubmit={handleSubmit}>
      ...
      <div className='reviews__rating-form form__rating'>
        {stars.map((star) => (
          <Fragment key={star}>
            <input className='form__rating-input visually-hidden' name='rating' value={star} id={`${star}-stars`} type='radio' checked={formData.rating.toString() === star.toString()} onChange={handleRatingChange} key={star} />
      ...
      <textarea className='reviews__textarea form__textarea' id='review' name='review' placeholder='Tell how was your stay, what you like and what can be improved' minLength={MIN_COMMENTS_LENGTH} maxLength={MAX_COMMENTS_LENGTH} onChange={handleCommentChange} value={formData.comment}></textarea>
